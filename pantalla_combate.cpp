    ...
    : botoneraAcciones(coordenadasAcciones, sf::Color(0, 0, 0, 150), acciones, 3)
{
    ...
    {
        std::cerr << "PantallaCombate: no se pudo cargar la fuente\n";
    }

    // -- Fondo ---------------------------------------------------------------
    if (!backgroundTexture.loadFromFile("recursos/imag/Cueva/cueva_1280x720.png"))
    {
        std::cerr << "PantallaCombate: no se pudo cargar el fondo\n";
    }
    else
    {
...
// ---------------------------------------------------------------------------
void PantallaCombate::setJugadorSeleccionado(int id)
{
...
bool PantallaCombate::cargarPartidaPorId(int idPartida)
{
...
bool PantallaCombate::cargarUltimaPartida()
{
...
// Ciclo principal
// ---------------------------------------------------------------------------
PantallaResultado PantallaCombate::handleEvent(const sf::Event& event,
...
void PantallaCombate::updateLayout(const sf::RenderWindow& window)
{
...
void PantallaCombate::draw(sf::RenderWindow& window) const
{
...
// ---------------------------------------------------------------------------
void PantallaCombate::accionAtacar()
{
    combate.aplicarAtaqueJugador();
    actualizarTextosCombate();
}

void PantallaCombate::accionCurar()
{
...
// Carga de sprites
// ---------------------------------------------------------------------------
void PantallaCombate::recargarSpriteJugador()
{
    ...
    {
        std::cerr << "PantallaCombate: no se pudo cargar " << ruta << '\n';
        return;
    }
    jugadorSprite.setTexture(jugadorTexture, true);
}

void PantallaCombate::recargarSpriteEnemigo()
{
...
// ---------------------------------------------------------------------------
void PantallaCombate::posicionarSpritesCombate(const sf::Vector2u& windowSize)
{
...
// ---------------------------------------------------------------------------
void PantallaCombate::posicionarPanelCombate(const sf::Vector2u& windowSize)
{
...
void PantallaCombate::posicionarPanelInventario(const sf::Vector2u& windowSize)
{
...
void PantallaCombate::alinearTextoControles()
{
...
// ---------------------------------------------------------------------------
void PantallaCombate::actualizarTextoJugador()
{
    textoJugador.setString(
        std::string("Personaje elegido: ") + combate.getNombreJugador());
}

void PantallaCombate::actualizarTextosCombate()
{
...
void PantallaCombate::actualizarTextoInventario()
{
